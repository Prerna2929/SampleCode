...
static const int NOTIFICATION_VIEW_HEIGHT = 36;
...
//    self.frame = CGRectMake(0, 1, screenBounds.size.width, NOTIFICATION_VIEW_HEIGHT);
    
    [self setupNotificationType];
    
    // create the labels
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 1, screenBounds.size.width, NOTIFICATION_VIEW_HEIGHT)];
