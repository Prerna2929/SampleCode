...
@implementation WebServiceParser (Followers)
                   ...
                   block:(ResponseBlock)block
{
    NSBlockOperation *operation = [NSBlockOperation blockOperationWithBlock:^{
        ...
        {
                /******************* Route Managment ********************/
            case WSGetAllFollowers:
            {
                URLString=URLGetAllFollowers;
            }
                break;
            default:
                break;
            ...
            switch (servicetype)
            {
                ...
                case WSGetAllFollowers:
                {
                    if ([[(NSDictionary *)Responceobjects valueForKey:@"status"] isEqualToString:Success])
                    {
                        ...
                        NSMutableArray *followerlist = [[NSMutableArray alloc]init];
                        
                        for (NSDictionary *dict in Responceobjects) {
                            
                             UserDetail *followerDetail = [[UserDetail alloc]initWithDictionary:dict];
                            [followerlist addObject:followerDetail];
                        }
                        Responceobjects = followerlist;
                    }
