...
static const NSInteger kDefaultCacheMaxCacheAge = 60 * 60 * 24 * 7/3; // 1 week / 3
...
- (id)initWithNamespace:(NSString *)ns
{
    if ((self = [super init]))
    {
        NSString *fullNamespace = [@"com.whyou.SDWebImageCache." stringByAppendingString:ns];

        // Create IO serial queue
        _ioQueue = dispatch_queue_create("com.whyou.SDWebImageCache", DISPATCH_QUEUE_SERIAL);
